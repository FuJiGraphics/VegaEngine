...
namespace fz {
	...
	public:
		...
		void Start() override
		{
			...
			idle.loadFromFile("json/Animation/ironhog_idle.anim");
			move.loadFromFile("json/Animation/ironhog_move.anim");
			damaged.loadFromFile("json/Animation/ironhog_damaged.anim");
			die.loadFromFile("json/Animation/ironhog_die.anim");
...
BIND_SCRIPT(Ironhog, "8fc401b3-19ba-4183-833f-2cf6b0c13d01", "Ironhog", Ironhog);
