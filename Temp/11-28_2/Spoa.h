...
namespace fz {
	...
	public:
		...
		void Start() override
		{
			...
			idle.loadFromFile("json/Animation/spoa_idle.anim");
			move.loadFromFile("json/Animation/spoa_move.anim");
			damaged.loadFromFile("json/Animation/spoa_damaged.anim");
			die.loadFromFile("json/Animation/spoa_die.anim");
...
BIND_SCRIPT(Spoa, "8fc401b3-19ba-4183-833f-2cf6b0c13d01", "Spoa", Spoa);
