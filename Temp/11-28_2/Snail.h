...
namespace fz {
	...
	public:
		...
		void Start() override
		{
			...
			idle.loadFromFile("json/Animation/snail_idle.anim");
			move.loadFromFile("json/Animation/snail_move.anim");
			damaged.loadFromFile("json/Animation/snail_damaged.anim");
			die.loadFromFile("json/Animation/snail_die.anim");
			body->SetGravityScale(1.5f);
		}

		void OnDestroy() override
		{
			FZLOG_DEBUG("달팽이 스크립트 파괴! {0} {1}", 1.1, "aSDASCA");
		}
...
BIND_SCRIPT(Snail, "8fc401b3-19ba-4183-833f-2cf6b0c13d01", "Snail", Snail);
