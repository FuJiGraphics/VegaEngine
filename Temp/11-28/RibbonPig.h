...
namespace fz {
	...
	public:
		...
		void Start() override
		{
			...
			idle.loadFromFile("json/Animation/ribbon_pig_idle.anim");
			move.loadFromFile("json/Animation/ribbon_pig_move.anim");
			damaged.loadFromFile("json/Animation/ribbon_pig_damaged.anim");
			die.loadFromFile("json/Animation/ribbon_pig_die.anim");
