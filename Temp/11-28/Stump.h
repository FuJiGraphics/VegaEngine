...
namespace fz {
	...
	public:
		...
		void Start() override
		{
			...
			idle.loadFromFile("json/Animation/Stump_idle.anim");
			move.loadFromFile("json/Animation/Stump_move.anim");
			damaged.loadFromFile("json/Animation/Stump_damaged.anim");
			die.loadFromFile("json/Animation/Stump_die.anim");
...
BIND_SCRIPT(Stump, "8fc401b3-19ba-4183-833f-2cf6b0c13d01", "Stump", Stump);
